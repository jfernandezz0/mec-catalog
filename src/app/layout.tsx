  ...
  return (
    <html lang="es" className={jakarta.className}>
      ...
      <body className="bg-[color:var(--bg-page)] text-[color:var(--text-primary)] antialiased flex flex-col min-h-screen">
        ...
        <footer className="py-8 flex flex-col items-center gap-4 border-t border-[color:var(--border-card)]">
          <p className="text-xs text-[color:var(--text-secondary)] text-center px-4 max-w-md leading-relaxed">
            Colabora con el equipo de ingeniería aquí:{' '}
            <a
              ...
              className="inline-flex items-center justify-center p-1.5 rounded-full bg-[color:var(--bg-card)] hover:bg-[color:var(--border-card)] border border-[color:var(--border-card)] text-[color:var(--text-primary)] transition-all hover:scale-110 mx-1 align-middle shadow-sm hover:shadow"
            ...
            , se lo gastarán todo en nuevas herramientas y gasolina 98.
          </p>
          <Image
            src="/logo_txt.png"
            alt="MiniEngines Creations"
